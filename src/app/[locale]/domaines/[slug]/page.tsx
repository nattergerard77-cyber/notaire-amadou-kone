        ...
        <div className="section-container">
          ...
          <div className="area-layout">
            ...
            <aside className="area-sidebar">
              ...
              <div className="area-sidebar-list animate-card hover-lift">
                ...
                <a href="https://wa.me/22389585761" className="area-sidebar-item">
                ...
                <a href="tel:+22389585761" className="area-sidebar-item">
                  <Phone size={22} />
                  <span>
                    <strong>Téléphone</strong>
                    <small>+22389585761<br />Lun–Jeu : 08h–17h</small>
                  </span>
                </a>
          ...
          <section className="area-bottom-cta animate-card hover-lift">
            ...
            <div className="area-bottom-actions">
              ...
              <a href="https://wa.me/22389585761" className="area-outline-btn">
