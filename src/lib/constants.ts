...
export const ENGAGEMENTS = [
  ...
  { num: '04', title: 'Impartialité', desc: 'En tant\'officier public, le notaire conseille toutes les parties avec équité et neutralité absolue.' },
...
export const BLOG_ARTICLES = [
  { slug: 'acheter-terrain-bamako-2025', title: 'Comment sécuriser l\'achat d\'un terrain à Bamako en 2025', excerpt: 'Vérification du titre foncier, risques à éviter, rôle du notaire dans la transaction immobilière au Mali.', date: '2025-04-15', author: 'Maître Amadou Koné', category: 'Immobilier', tag: 'Guide pratique' },
  { slug: 'succession-mali-droits', title: 'Succession au Mali : vos droits selon le Code civil et le droit coutumier', excerpt: 'Ce que la loi prévoit, les dérogations possibles et l\'importance du testament.', date: '2025-03-02', author: 'Maître Salimata Dembélé', category: 'Succession', tag: 'Famille' },
  { slug: 'creer-sarl-mali', title: 'Créer une SARL au Mali : étapes et documents indispensables', excerpt: 'De la rédaction des statuts à l\'immatriculation au RCCM, tout le processus expliqué.', date: '2025-01-20', author: 'Maître Amadou Koné', category: 'Affaires', tag: 'Droit des affaires' },
  { slug: 'droits-enregistrement-immobilier', title: 'Nouvelles dispositions sur les droits d\'enregistrement immobilier au Mali', excerpt: 'Analyse des changements fiscaux et leur impact sur les transactions foncières.', date: '2024-12-10', author: 'Cabinet Koné', category: 'Actualité', tag: 'Actualités légales' },
  { slug: 'contrat-mariage-mali', title: 'Le contrat de mariage : pourquoi le choisir et comment le rédiger ?', excerpt: 'Les régimes matrimoniaux applicables au Mali, leurs avantages et inconvénients.', date: '2024-11-05', author: 'Maître Salimata Dembélé', category: 'Famille', tag: 'Guide pratique' },
  { slug: 'bail-commercial-location', title: 'Bail commercial ou location simple : quelle protection pour votre local ?', excerpt: 'Différences juridiques, droits du locataire et garanties du propriétaire au Mali.', date: '2024-10-18', author: 'Maître Amadou Koné', category: 'Immobilier', tag: 'Immobilier' },
]
